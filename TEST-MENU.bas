...
DIM MENU_BLOCK(1 TO 6) AS STRING
...
' setup the images
IMG_MENU_LOGO& = _NEWIMAGE(101 * CW, 14 * CH, 32)
IMG_MENU_LEFT& = _NEWIMAGE(16 * CW, 48 * CH, 32)
IMG_MENU_RIGHT& = _NEWIMAGE(16 * CW, 48 * CH, 32)
...
_PUTIMAGE (117*CW, 1*CH)
_SOURCE IMG_MENU_BLOCK&
_PUTIMAGE (16*CW, 20*CH)
