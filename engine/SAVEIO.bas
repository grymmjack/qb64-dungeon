...
'
'  The slot path is SAVE_FILE (ENGINE.BI), set by the game at startup -- so the engine holds
'  no game-chosen filename, and a test can point the whole save system at a scratch file.
' ============================================================================

FUNCTION HasSave%
    HasSave = (_FILEEXISTS(SAVE_FILE) <> 0)
END FUNCTION
