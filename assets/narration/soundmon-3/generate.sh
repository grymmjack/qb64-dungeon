#!/usr/bin/env bash
# Regenerate the soundmon-3 narration set (bm_fable) from lines.txt.
#
...
VOICE="${VOICE:-bm_fable}"     # British male, warm storyteller
PITCH="${PITCH:--2}"            # lighter drop — this voice is already warm
SPEED="${SPEED:-0.95}"        # a touch brisker, more "telling a tale"
